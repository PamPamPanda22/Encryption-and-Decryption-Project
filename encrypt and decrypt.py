...
def encrypt(plain_text, key):
    ...
    encrypted_text = cipher.encrypt(plain_text.encode('utf-8')) #encrypting the plain text (encoding into utf-8 turns the plain text into byte format)
...
def decrypt(encoded, key):
    ...
    iv = decoded[:16] #extracting the first 16 decoded bytes
    encrypted_text = decoded[16:] #extracting the last 16 decoded bytes
...
def main():
    ...
    print(f"This is your decrypted message: {decrypted_message}")
